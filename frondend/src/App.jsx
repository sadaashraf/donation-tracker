...
export default function App() {
  ...
  const renderContent = () => {
    ...
    if (screen === "members")   return <MembersScreen setModal={setModal} refresh={memberRefresh} />;
  ...
  return (
    <div className="min-h-screen bg-gray-50 md:bg-gray-200 flex flex-col md:flex-row">
      ...
      <main className="flex-1 flex flex-col overflow-hidden relative min-h-screen md:min-h-0">
        {renderContent()}
        {modal && <AddMemberModal onClose={() => setModal(false)} onSaved={() => setMemberRefresh(r => r + 1)} />}
